...
Donate link: https://congcuseoai.com
Tags: ai, image generator, gemini, imagen, openai, 9router, media
...
AI Image Generator by CongCuSEOAI giúp tạo ảnh minh họa cho bài viết WordPress. Plugin phân tích tiêu đề, tóm tắt và nội dung bài viết để tạo prompt bằng OpenAI hoặc Gemini, sau đó tạo ảnh bằng Gemini Enterprise Agent Platform (Agent Platform AI) hoặc endpoint 9router/OpenAI-compatible do quản trị viên cấu hình.
...
* Hỗ trợ image providers: Gemini Enterprise Agent Platform (Agent Platform AI) và 9router/OpenAI-compatible endpoint.
...
* Gemini Enterprise Agent Platform: Gemini 3.1 Flash Image Preview và Gemini 3 Pro Image Preview.
* 9router/OpenAI-compatible endpoint: endpoint tùy chỉnh hỗ trợ `/v1/models` và `/v1/images/generations`.

= Hỗ Trợ =

* Website: https://congcuseoai.com
* Facebook: https://www.facebook.com/ngoctu.gttn
...
2. Tìm "AI Image Generator by CongCuSEOAI".
3. Click Install Now.
4. Click Activate.
...
* Gemini Enterprise Agent Platform image provider: dùng Google Cloud service account JSON có quyền Vertex AI User. Agent Platform hiện vẫn dùng IAM và REST endpoint kỹ thuật của Vertex AI API.

== Screenshots ==

1. Settings page - cấu hình Prompt AI.
2. Settings page - cấu hình Gemini Enterprise Agent Platform.
...
Used when Gemini is selected as the prompt provider or Gemini Enterprise Agent Platform is selected as the image provider.
